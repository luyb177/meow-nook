...
func ApplyAdoptHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ApplyAdoptReq
		...
		l := adoption.NewApplyAdoptLogic(r.Context(), svcCtx)
		resp, err := l.ApplyAdopt(&req)
		if err != nil {
