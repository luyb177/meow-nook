...
func ApproveAdoptHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ApproveAdoptReq
		...
		l := adoption.NewApproveAdoptLogic(r.Context(), svcCtx)
		resp, err := l.ApproveAdopt(&req)
		if err != nil {
