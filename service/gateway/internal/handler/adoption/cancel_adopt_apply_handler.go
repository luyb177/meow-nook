...
func CancelAdoptApplyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CancelAdoptApplyReq
		...
		l := adoption.NewCancelAdoptApplyLogic(r.Context(), svcCtx)
		resp, err := l.CancelAdoptApply(&req)
		if err != nil {
