...
func CreateAdoptionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateAdoptionReq
		...
		l := adoption.NewCreateAdoptionLogic(r.Context(), svcCtx)
		resp, err := l.CreateAdoption(&req)
		if err != nil {
