...
func DirectAdoptHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DirectAdoptReq
		...
		l := adoption.NewDirectAdoptLogic(r.Context(), svcCtx)
		resp, err := l.DirectAdopt(&req)
		if err != nil {
