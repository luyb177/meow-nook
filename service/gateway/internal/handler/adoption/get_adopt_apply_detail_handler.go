...
func GetAdoptApplyDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetAdoptApplyDetailReq
		...
		l := adoption.NewGetAdoptApplyDetailLogic(r.Context(), svcCtx)
		resp, err := l.GetAdoptApplyDetail(&req)
		if err != nil {
