...
func GetAdoptionDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetAdoptionDetailReq
		...
		l := adoption.NewGetAdoptionDetailLogic(r.Context(), svcCtx)
		resp, err := l.GetAdoptionDetail(&req)
		if err != nil {
