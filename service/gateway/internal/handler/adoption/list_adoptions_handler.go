...
func ListAdoptionsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListAdoptionsReq
		...
		l := adoption.NewListAdoptionsLogic(r.Context(), svcCtx)
		resp, err := l.ListAdoptions(&req)
		if err != nil {
