...
func ListMyAdoptionsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListMyAdoptionsReq
		...
		l := adoption.NewListMyAdoptionsLogic(r.Context(), svcCtx)
		resp, err := l.ListMyAdoptions(&req)
		if err != nil {
