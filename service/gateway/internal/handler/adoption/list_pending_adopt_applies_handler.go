...
func ListPendingAdoptAppliesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListPendingAdoptAppliesReq
		...
		l := adoption.NewListPendingAdoptAppliesLogic(r.Context(), svcCtx)
		resp, err := l.ListPendingAdoptApplies(&req)
		if err != nil {
