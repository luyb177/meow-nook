...
func RecordFollowUpVisitHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RecordFollowUpVisitReq
		...
		l := adoption.NewRecordFollowUpVisitLogic(r.Context(), svcCtx)
		resp, err := l.RecordFollowUpVisit(&req)
		if err != nil {
