...
func RejectAdoptHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RejectAdoptReq
		...
		l := adoption.NewRejectAdoptLogic(r.Context(), svcCtx)
		resp, err := l.RejectAdopt(&req)
		if err != nil {
