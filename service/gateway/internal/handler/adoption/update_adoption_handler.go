...
func UpdateAdoptionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateAdoptionReq
		...
		l := adoption.NewUpdateAdoptionLogic(r.Context(), svcCtx)
		resp, err := l.UpdateAdoption(&req)
		if err != nil {
