...
func UpdateReturnStatusHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateReturnStatusReq
		...
		l := adoption.NewUpdateReturnStatusLogic(r.Context(), svcCtx)
		resp, err := l.UpdateReturnStatus(&req)
		if err != nil {
